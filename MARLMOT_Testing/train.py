...
import argparse
from train_world import TrainWorld
from dataloader import ImageDataloader  # Change to ImageDataloader
from network import Net
from ppo import PPO
...
def get_args():
    ...
    parser.add_argument("--imagefolder", dest="imagefolder", type=str,  # Change to --imagefolder
                        default=r"/path/to/image/folder")  # Set the path to your image folder
    parser.add_argument("--savepath", dest="savepath", type=str,
                        default=os.path.join(DIR_PATH, r"trained_models"))
    args = parser.parse_args()
...
if __name__ == "__main__":
    ...
    # parse arguments
    args = get_args()
    image_folder = args.imagefolder  # Change to image_folder
    savepath = args.savepath 

    # get dataloader
    dataloader = ImageDataloader(image_folder)  # Change to ImageDataloader
